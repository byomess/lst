...
def get_row_data(entry, path, options, directory_sizes=None):
    ...
    try:
        ...
        entry_color = 'green' if is_executable else ('blue' if is_dir else 'default')
...
parser.add_argument('-s', '--sort-by', choices=['name', 'size', 'created', 'modified'], default='name', help='Sort by name (default), size, creation date, or modification date.')
